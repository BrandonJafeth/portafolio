...
export default function Contact() {
  ...
  return (
    <section className="py-24 max-w-6xl mx-auto px-4 sm:px-6 relative overflow-hidden" id="contact">
      {/* Subtle Background Glow */}
      <div className="absolute top-1/2 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-primary/5 rounded-full blur-[80px] sm:blur-[100px] -z-10" />
